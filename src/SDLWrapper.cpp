...
Uint32 SDL2::init() { return SDL_Init(SDL_INIT_VIDEO); }
...
Uint32 SDL2::pollEvent(SDL2::Event *event) { return SDL_PollEvent(event); }
...
void SDL2::prepareScene(SDL2::Renderer renderer, Uint8 r, Uint8 g, Uint8 b,
                        Uint8 a) {
...
Uint64 SDL2::elapsedTimeInMillis() { return SDL_GetTicks64(); }

void SDL2::delay(Uint32 timeInMillis) { SDL_Delay(timeInMillis); }
